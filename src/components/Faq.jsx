...
function Faq() {
  return (
   <section>
     <h2 className='font-bold text-center lg:text-3xl text-2xl leading-tight'>FAQs</h2>
 <div className="space-y-4">
        {faqs.map((item, index) => (
          <div className="collapse collapse-plus border border-base-300" key={index}>
            <input type="radio" name="faq-accordion" defaultChecked={index === 0} />
            <div className="collapse-title font-bold text-white">{item.q}</div>
